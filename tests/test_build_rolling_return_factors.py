...
from microfactor.factor_registry import FAMILIES
...
from microfactor.preprocess_profile import RANK_PROFILES
...
def test_run_build_stage_raw_dispatches_raw_builder(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("microfactor.pipeline.compute_raw_family_factors", fake_raw)
