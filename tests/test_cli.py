...
def test_evaluate_summary_command_prints_report_paths(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "microfactor.cli.evaluate_cmds.generate_evaluation_report",
...
""",
    ...
    def fake_load_config(path):
        return type(
            ...
            (),
            {
                ...
                "start_date": "20230101",
                "end_date": "20231231",
                "microshare_data_dir": tmp_path / "microshare",
                "notify_webhook_url": "",
            },
        )()
    ...
    monkeypatch.setattr("microfactor.cli.evaluate_cmds.load_config", fake_load_config)
    monkeypatch.setattr("microfactor.cli.evaluate_cmds.AppContext", FakeAppContext)
    monkeypatch.setattr("microfactor.cli.evaluate_cmds.EvaluationService", FakeService)
    monkeypatch.setattr(
        "microfactor.cli.evaluate_cmds.generate_evaluation_report",
    ...
    from microfactor.notify import NullNotifier

    monkeypatch.setattr("microfactor.cli.evaluate_cmds.load_notifier", lambda cfg: NullNotifier())
...
""",
    ...
    monkeypatch.setattr("microfactor.cli.evaluate_cmds.AppContext", FakeAppContext)
    monkeypatch.setattr("microfactor.cli.evaluate_cmds.EvaluationService", FakeService)
    monkeypatch.setattr("microfactor.cli.evaluate_cmds.load_notifier", lambda cfg: object())
...
""".lstrip(),
    ...
    monkeypatch.setattr("microfactor.cli.compute_cmds.run_build_stage", fake_run_build_stage)
...
""".lstrip(),
    ...
    monkeypatch.setattr(
        "microfactor.cli.compute_cmds.run_build_stage",
    ...
    monkeypatch.setattr("microfactor.cli.compute_cmds.update_factor_registry", fake_update_registry)
...
def test_build_factors_external_data_provider_family_uses_compute_service(
    ...
    from microfactor.families import FactorFamily
...
""".lstrip(),
    ...
    monkeypatch.setattr("microfactor.cli.compute_cmds.AppContext", FakeAppContext)
    monkeypatch.setattr("microfactor.cli.compute_cmds.FactorComputeService", FakeService)
