...
from microfactor.eval.domain import EvaluationRequest, FactorEvaluationResult
from microfactor.eval.figures import FactorFigureWriter
from microfactor.eval.selection import FactorSelector
from microfactor.eval.workflow import (
...
def test_workflow_notifies_start_progress_and_eval_done(tmp_path, monkeypatch):
    monkeypatch.setattr(
        "microfactor.eval.workflow.SerialEvaluationExecutor",
...
def test_workflow_rejects_custom_components_with_process_pool(tmp_path, monkeypatch):
    monkeypatch.setattr(
        "microfactor.eval.workflow.ProcessPoolEvaluationExecutor",
