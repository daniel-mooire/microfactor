...
**Goal:** Build a configurable cross-sectional preprocessing pipeline for microfactor with winsorization, imputation, standardization, and a guarded neutralization interface.

**Architecture:** Add a focused `microfactor.preprocess` package. Core functions operate on wide `pandas.DataFrame` panels by trade date, while `FactorPreprocessPipeline` handles long-table conversion and fixed step ordering.

**Tech Stack:** Python 3.11, pandas, pytest, existing microfactor `trade_date, ts_code, value` schema.

---

## File Structure

- Create `microfactor/preprocess/__init__.py`: public exports.
- Create `microfactor/preprocess/winsorize.py`: MAD and quantile clipping.
- Create `microfactor/preprocess/impute.py`: cross-sectional median filling and industry guard.
- Create `microfactor/preprocess/standardize.py`: z-score and percentile rank standardization.
- Create `microfactor/preprocess/neutralize.py`: neutralization guard interface.
- Create `microfactor/preprocess/pipeline.py`: `PreprocessConfig`, input conversion, fixed-order pipeline.
...
- Create: `microfactor/preprocess/winsorize.py`
- Create: `microfactor/preprocess/__init__.py`
...
Expected: FAIL with `ModuleNotFoundError: No module named 'microfactor.preprocess'`.
...
```bash
git add tests/test_preprocess.py microfactor/preprocess/__init__.py microfactor/preprocess/winsorize.py
...
- Create: `microfactor/preprocess/impute.py`
- Modify: `microfactor/preprocess/__init__.py`
...
Expected: FAIL with `ModuleNotFoundError: No module named 'microfactor.preprocess.impute'`.
...
```bash
git add tests/test_preprocess.py microfactor/preprocess/__init__.py microfactor/preprocess/impute.py
...
**Files:**
- Modify: `tests/test_preprocess.py`
- Create: `microfactor/preprocess/standardize.py`
- Modify: `microfactor/preprocess/__init__.py`
...
Expected: FAIL with `ModuleNotFoundError: No module named 'microfactor.preprocess.standardize'`.
...
```bash
git add tests/test_preprocess.py microfactor/preprocess/__init__.py microfactor/preprocess/standardize.py
...
**Files:**
- Modify: `tests/test_preprocess.py`
- Create: `microfactor/preprocess/neutralize.py`
- Modify: `microfactor/preprocess/__init__.py`
...
Expected: FAIL with `ModuleNotFoundError: No module named 'microfactor.preprocess.neutralize'`.
...
```bash
git add tests/test_preprocess.py microfactor/preprocess/__init__.py microfactor/preprocess/neutralize.py
...
**Files:**
- Modify: `tests/test_preprocess.py`
- Create: `microfactor/preprocess/pipeline.py`
- Modify: `microfactor/preprocess/__init__.py`
...
def test_preprocess_config_rejects_invalid_quantile_bounds():
    from microfactor.preprocess import PreprocessConfig
...
```bash
git add tests/test_preprocess.py microfactor/preprocess/__init__.py microfactor/preprocess/pipeline.py
...
```bash
git add tests/test_preprocess.py microfactor/preprocess
