...
| spec planning | `quantaalpha/factors/prompts/prompts.yaml` | `hypothesis2experiment`, wrapped with microfactor constraints |
...
| code generation | `quantaalpha/factors/coder/prompts.yaml` | implementation prompt, wrapped with microfactor code rules |
...
## microfactor Wrapper For Spec Generation
...
## microfactor Wrapper For Code Generation
