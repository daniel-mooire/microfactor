...
```text
-ts_cov(ts_cov(delay(low,3),turn,7),turn,7)
```

输入字段：`low, turnover_rate`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha3`
...
- Rank IC Mean：`0.0183679539899`
- Rank ICIR：`0.229844664863`
- Adjusted ICIR：`0.229844664863`
- Long-short spread (bps)：`10.7029341821`
- Monotonicity：`0.139393939394`
- Coverage：`0.858457076566`
- Daily turnover (long)：`0.26857328244`
- Daily turnover (short)：`0.224942005818`
