...
```text
rank_div(rank_sub(rank_div(close,open),open),ts_min(sub(free_turn,close),3))
```

输入字段：`close, open, turnover_rate_f`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha7`
...
- Rank IC Mean：`-0.00418659550841`
- Rank ICIR：`-0.0441146732002`
- Adjusted ICIR：`-0.0441146732002`
- Long-short spread (bps)：`-6.15167742262`
- Monotonicity：`-0.527272727273`
- Coverage：`0.954797614467`
- Daily turnover (long)：`0.490378249158`
- Daily turnover (short)：`0.765269902647`
