...
```text
-ts_min(ts_prod(delta(vwap,10),10),10)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha18`
...
- 因子版本：`a330d32bc12ffb9cbf9f`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-02-18` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`-0.0173065017601`
- Rank ICIR：`-0.156055179982`
- Adjusted ICIR：`-0.156055179982`
- Long-short spread (bps)：`-7.10952434186`
- Monotonicity：`-0.866666666667`
- Coverage：`0.813978235523`
- Daily turnover (long)：`0.0819411083742`
- Daily turnover (short)：`0.17001934288`
