...
```text
-div(rank_div(vwap,volume),ts_prod(close,10))
```

输入字段：`vwap, volume, close`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha13`
...
- Rank IC Mean：`-0.0172442981252`
- Rank ICIR：`-0.127669377609`
- Adjusted ICIR：`-0.127669377609`
- Long-short spread (bps)：`-14.0208486643`
- Monotonicity：`-0.963636363636`
- Coverage：`0.88402970679`
- Daily turnover (long)：`0.077818295442`
- Daily turnover (short)：`0.0486345556875`
