...
```text
-ts_cov(ts_cov(sub(vwap,close),high,5),turn,7)
```

输入字段：`vwap, close, high, turnover_rate`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha4`
...
- Rank IC Mean：`-0.0181674117247`
- Rank ICIR：`-0.29144056691`
- Adjusted ICIR：`0.29144056691`
- Long-short spread (bps)：`13.3788035989`
- Monotonicity：`0.430303030303`
- Coverage：`0.879521806252`
- Daily turnover (long)：`0.266213673658`
- Daily turnover (short)：`0.238860039346`
