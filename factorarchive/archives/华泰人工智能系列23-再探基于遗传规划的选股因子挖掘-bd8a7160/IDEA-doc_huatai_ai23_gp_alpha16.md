...
```text
-mul(return1,mul(turn,decay_linear(turn,5)))
```

输入字段：`close_to_close_total_return_1d, turnover_rate`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha16`
...
- Rank IC Mean：`0.0325896977643`
- Rank ICIR：`0.28847449866`
- Adjusted ICIR：`0.28847449866`
- Long-short spread (bps)：`21.1036591731`
- Monotonicity：`0.29696969697`
- Coverage：`0.92226877166`
- Daily turnover (long)：`0.69820738184`
- Daily turnover (short)：`0.721371613366`
