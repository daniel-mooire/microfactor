...
```text
-sigmoid(rank_div(mul(volume,high),rank(high)))
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha23`
...
- Rank IC Mean：`0.0372009931326`
- Rank ICIR：`0.325252080972`
- Adjusted ICIR：`0.325252080972`
- Long-short spread (bps)：`2.582257217`
- Monotonicity：`0.515151515152`
- Coverage：`0.998898500577`
- Daily turnover (long)：`0.334795900058`
- Daily turnover (short)：`0.155627240603`
