...
```text
mul(free_turn,rank_sub(open,delta(volume,9)))
```

输入字段：`turnover_rate_f, open, volume`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha20`
...
- Rank IC Mean：`0.0158349397337`
- Rank ICIR：`0.142412151017`
- Adjusted ICIR：`0.142412151017`
- Long-short spread (bps)：`3.64158733896`
- Monotonicity：`-0.260606060606`
- Coverage：`0.950303240741`
- Daily turnover (long)：`0.309171839541`
- Daily turnover (short)：`0.412709438366`
