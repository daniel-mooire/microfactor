...
```text
-ts_cov(ts_max(turn,7),free_turn,9)
```

输入字段：`turnover_rate, turnover_rate_f`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha6`
...
- Rank IC Mean：`0.0467566297536`
- Rank ICIR：`0.555639001206`
- Adjusted ICIR：`0.555639001206`
- Long-short spread (bps)：`17.3464973517`
- Monotonicity：`0.648484848485`
- Coverage：`0.862477386935`
- Daily turnover (long)：`0.389159722217`
- Daily turnover (short)：`0.184300008076`
