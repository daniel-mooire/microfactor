...
```text
-mul(free_turn,mul(ts_cov(low,high,5),delta(low,5)))
```

输入字段：`turnover_rate_f, low, high`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha9`
...
- Rank IC Mean：`0.0352981630122`
- Rank ICIR：`0.305625440718`
- Adjusted ICIR：`0.305625440718`
- Long-short spread (bps)：`24.1696521957`
- Monotonicity：`0.466666666667`
- Coverage：`0.909805855162`
- Daily turnover (long)：`0.370536143893`
- Daily turnover (short)：`0.339357763945`
