...
```text
-mul(free_turn,mul(high,delta(low,5)))
```

输入字段：`turnover_rate_f, high, low`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha15`
...
- Rank IC Mean：`0.0358978328337`
- Rank ICIR：`0.30426954038`
- Adjusted ICIR：`0.30426954038`
- Long-short spread (bps)：`23.0528482917`
- Monotonicity：`0.478787878788`
- Coverage：`0.929633281972`
- Daily turnover (long)：`0.382003820022`
- Daily turnover (short)：`0.341529280943`
