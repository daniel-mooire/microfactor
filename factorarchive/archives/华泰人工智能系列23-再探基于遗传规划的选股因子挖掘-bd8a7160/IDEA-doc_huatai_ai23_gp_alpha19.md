...
```text
-ts_cov(ts_stddev(turn,4),close,6)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha19`
...
- Rank IC Mean：`0.0336541275676`
- Rank ICIR：`0.488527896425`
- Adjusted ICIR：`0.488527896425`
- Long-short spread (bps)：`13.7668140422`
- Monotonicity：`0.357575757576`
- Coverage：`0.888915927497`
- Daily turnover (long)：`0.351828943175`
- Daily turnover (short)：`0.271029945789`
