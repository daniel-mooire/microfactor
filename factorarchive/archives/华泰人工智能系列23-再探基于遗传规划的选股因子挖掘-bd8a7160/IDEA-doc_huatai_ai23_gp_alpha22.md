...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha22`
...
- Rank IC Mean：`-0.0204627289334`
- Rank ICIR：`-0.166076566207`
- Adjusted ICIR：`-0.166076566207`
- Long-short spread (bps)：`1.42809854173`
- Monotonicity：`-0.030303030303`
- Coverage：`0.998898500577`
- Daily turnover (long)：`0.111222660181`
- Daily turnover (short)：`0.224546781735`
