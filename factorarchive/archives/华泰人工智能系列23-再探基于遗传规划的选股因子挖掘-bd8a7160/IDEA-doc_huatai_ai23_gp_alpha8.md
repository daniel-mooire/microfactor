...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha8`
...
- Rank IC Mean：`-0.0131969311942`
- Rank ICIR：`-0.138746885285`
- Adjusted ICIR：`-0.138746885285`
- Long-short spread (bps)：`-10.5892319624`
- Monotonicity：`-0.672727272727`
- Coverage：`0.888931739298`
- Daily turnover (long)：`0.240167561904`
- Daily turnover (short)：`0.487180001999`
