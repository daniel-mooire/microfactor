...
```text
-mul(ts_sum(vwap,5),ts_cov(volume,vwap,3))
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha5`
...
- Rank IC Mean：`0.051439064404`
- Rank ICIR：`0.603030279015`
- Adjusted ICIR：`0.603030279015`
- Long-short spread (bps)：`17.5700633836`
- Monotonicity：`0.648484848485`
- Coverage：`0.922277628032`
- Daily turnover (long)：`0.65928775564`
- Daily turnover (short)：`0.453493588156`
