...
```text
-ts_cov(mul(close,return1),turn,7)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha11`
...
- Rank IC Mean：`0.0397123087566`
- Rank ICIR：`0.479139442816`
- Adjusted ICIR：`0.479139442816`
- Long-short spread (bps)：`13.5471894104`
- Monotonicity：`0.442424242424`
- Coverage：`0.894509637625`
- Daily turnover (long)：`0.347235018388`
- Daily turnover (short)：`0.265040668001`
