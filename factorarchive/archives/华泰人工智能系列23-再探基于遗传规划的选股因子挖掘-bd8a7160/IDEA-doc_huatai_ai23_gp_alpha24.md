...
```text
sigmoid(ts_prod(rank_div(vwap,free_turn),3))
```

输入字段：`vwap, turnover_rate_f`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai23_gp_alpha24`
...
- Rank IC Mean：`0.032080088092`
- Rank ICIR：`0.263530744544`
- Adjusted ICIR：`0.263530744544`
- Long-short spread (bps)：`-1.62702571893`
- Monotonicity：`0.2`
- Coverage：`0.954797614467`
- Daily turnover (long)：`0.18172309042`
- Daily turnover (short)：`0.102835216247`
