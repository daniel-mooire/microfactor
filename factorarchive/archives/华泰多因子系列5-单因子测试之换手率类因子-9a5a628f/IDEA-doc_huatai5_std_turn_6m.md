...
```text
std(turnover_percent[t-125:t], ddof=1)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai5_std_turn_6m`
...
- Rank IC Mean：`-0.0287858087499`
- Rank ICIR：`-0.252030186327`
- Adjusted ICIR：`0.252030186327`
- Long-short spread (bps)：`11.6082692307`
- Monotonicity：`0.987878787879`
- Coverage：`0.622808966074`
- Daily turnover (long)：`0.0242144891108`
- Daily turnover (short)：`0.0235954076856`
