...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai4_exp_wgt_return_3m`
- 默认参数：`{"distance_unit":"trading_day","minimum_valid_days":63,"months":3,"weight":"turnover_percent*exp(-x/months/4)","window_days":63}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0648521167738`
- Rank ICIR：`-0.542456138458`
- Adjusted ICIR：`0.542456138458`
- Long-short spread (bps)：`33.3280985892`
- Monotonicity：`0.927272727273`
- Coverage：`0.727548463357`
- Daily turnover (long)：`0.174686956422`
- Daily turnover (short)：`0.272141990324`
