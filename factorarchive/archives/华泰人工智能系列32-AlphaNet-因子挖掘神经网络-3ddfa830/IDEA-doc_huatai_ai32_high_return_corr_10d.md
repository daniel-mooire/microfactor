# doc_huatai_ai32_high_return_corr_10d
...
```text
ts_corr(high,return1,10)
```

输入字段：`high, close_to_close_total_return_1d`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai32_high_return_corr_10d`
