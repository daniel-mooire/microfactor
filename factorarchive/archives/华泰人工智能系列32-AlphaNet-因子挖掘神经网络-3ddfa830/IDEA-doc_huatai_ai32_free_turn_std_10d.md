# doc_huatai_ai32_free_turn_std_10d
...
```text
ts_stddev(free_turn,10)
```

输入字段：`turnover_rate_f`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai32_free_turn_std_10d`
