...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_bohai8_stoq_63d`
- 默认参数：`{"evaluation_sampling":"daily_rolling","source_factor":"STOQ","source_months":3,"source_sampling":"monthly","turnover_formula_unit":"fraction","turnover_input_unit":"percentage_points","window_days":63}`
...
- Rank IC Mean：`-0.0309598142919`
- Rank ICIR：`-0.243304399411`
- Adjusted ICIR：`0.243304399411`
