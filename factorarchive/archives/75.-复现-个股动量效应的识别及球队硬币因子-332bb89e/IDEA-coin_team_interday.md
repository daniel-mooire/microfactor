...
```text
mean20(close/pre_close-1) with low-volatility and low-turnover sign flips
```
...
- Python 实现：`microfactor.factors.document_factors::coin_team_interday`
- 默认参数：`{}`
...
- Rank IC Mean：`-0.0499735760952`
- Rank ICIR：`-0.578162785577`
- Adjusted ICIR：`0.578162785577`
- Long-short spread (bps)：`27.5102941384`
- Monotonicity：`0.951515151515`
- Coverage：`0.839972491282`
- Daily turnover (long)：`0.219651131739`
- Daily turnover (short)：`0.179368574003`
