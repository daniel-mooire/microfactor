...
Ranks the negative squared open-to-close relative price gap.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_185`
- 默认参数：`{"alpha191_number":185,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"rank(-1 * ((1 - (open / close)) ^ 2))","recursive_stability_window":null,"source_expression":"RANK((-1*((1-(OPEN/CLOSE))^2)))","source_fq":null}`
