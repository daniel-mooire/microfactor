...
Reverses the five-day relation between high prices and daily cross-sectional volume ranks.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_062`
- 默认参数：`{"alpha191_number":62,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"-1 * corr(high, rank(volume), 5)","recursive_stability_window":null,"source_expression":"(-1*CORR(HIGH,RANK(VOLUME),5))","source_fq":null}`
