...
输入字段：`close, high, low, open`

## 原理说明

Combines the close's distances from the daily low and high with the fifth power of the open-to-close ratio.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_171`
- 默认参数：`{"alpha191_number":171,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"(-1 * ((low - close) * (open ^ 5))) / ((close - high) * (close ^ 5))","recursive_stability_window":null,"source_expression":"((-1*((LOW-CLOSE)*(OPEN^5)))/((CLOSE-HIGH)*(CLOSE^5)))","source_fq":null}`
