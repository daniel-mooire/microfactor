...
Ranks the direction of a four-day move in an open/high blended price.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_006`
- 默认参数：`{"alpha191_number":6,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"-1 * rank(sign(delta((open * 0.85) + (high * 0.15), 4)))","recursive_stability_window":null,"source_expression":"(RANK(SIGN(DELTA((((OPEN * 0.85)+(HIGH * 0.15))),4)))*-1)","source_fq":null}`
