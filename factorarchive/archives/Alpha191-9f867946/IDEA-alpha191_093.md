...
Twenty-day accumulation of downside opening gaps and intraday open-to-low movement.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_093`
- 默认参数：`{"alpha191_number":93,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"sum((open >= delay(open, 1)) ? 0 : max(open - low, open - delay(open, 1)), 20)","recursive_stability_window":null,"source_expression":"SUM((OPEN>=DELAY(OPEN,1)?0:MAX(OPEN-LOW,OPEN-DELAY(OPEN,1))),20)","source_fq":null}`
