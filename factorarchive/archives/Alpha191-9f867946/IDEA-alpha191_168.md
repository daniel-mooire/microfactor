...
Negative ratio of current share volume to its twenty-day average.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_168`
- 默认参数：`{"alpha191_number":168,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"-1 * volume / mean(volume, 20)","recursive_stability_window":null,"source_expression":"(-1*VOLUME/MEAN(VOLUME,20))","source_fq":null}`
