...
One-day close return multiplied by current share volume.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_178`
- 默认参数：`{"alpha191_number":178,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"((close - delay(close, 1)) / delay(close, 1)) * volume","recursive_stability_window":null,"source_expression":"(CLOSE-DELAY(CLOSE,1))/DELAY(CLOSE,1)*VOLUME","source_fq":null}`
