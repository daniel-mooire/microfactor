...
Ranks the largest three-day VWAP increase observed during the last five days.
...
- Python 实现：`microfactor.factors.alpha191_document::alpha191_041`
- 默认参数：`{"alpha191_number":41,"normalization":"Only case and redundant parentheses were normalized.","normalized_expression":"-1 * rank(max(delta(vwap, 3), 5))","recursive_stability_window":null,"source_expression":"(RANK(MAX(DELTA((VWAP),3),5))*-1)","source_fq":null}`
