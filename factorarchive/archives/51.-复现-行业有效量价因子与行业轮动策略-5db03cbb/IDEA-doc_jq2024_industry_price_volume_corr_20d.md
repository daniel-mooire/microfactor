# doc_jq2024_industry_price_volume_corr_20d
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_jq2024_industry_price_volume_corr_20d`
- 默认参数：`{"correlation":"pearson","source_asset_type":"industry_etf","source_windows":[5,10,20,60,120,180],"window_days":20}`
