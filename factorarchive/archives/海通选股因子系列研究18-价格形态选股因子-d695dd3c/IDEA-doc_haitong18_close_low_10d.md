...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_haitong18_close_low_10d`
...
- Rank IC Mean：`-0.0560308933548`
- Rank ICIR：`-0.454248723209`
- Adjusted ICIR：`0.454248723209`
- Long-short spread (bps)：`18.8146170191`
- Monotonicity：`0.321212121212`
- Coverage：`0.962592435353`
- Daily turnover (long)：`0.227418880318`
- Daily turnover (short)：`0.187345964865`
