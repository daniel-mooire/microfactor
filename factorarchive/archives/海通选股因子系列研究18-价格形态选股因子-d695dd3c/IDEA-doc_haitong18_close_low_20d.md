...
```text
MEAN(log(close/low), i=t-20..t-1)
```

输入字段：`close, low, is_suspended`
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_haitong18_close_low_20d`
...
- Rank IC Mean：`-0.0544449093807`
- Rank ICIR：`-0.412099340258`
- Adjusted ICIR：`0.412099340258`
- Long-short spread (bps)：`17.0333246517`
- Monotonicity：`0.575757575758`
- Coverage：`0.950504455637`
- Daily turnover (long)：`0.132876210388`
- Daily turnover (short)：`0.125113732572`
