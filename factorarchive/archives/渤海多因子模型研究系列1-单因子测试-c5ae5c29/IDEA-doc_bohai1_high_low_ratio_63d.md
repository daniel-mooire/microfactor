...
```text
MAX(adjusted_high,63)/MIN(adjusted_low,63)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_bohai1_high_low_ratio_63d`
- 默认参数：`{"evaluation_sampling":"daily_rolling","source_months":3,"source_sampling":"month_end","window_days":63}`
...
- Rank IC Mean：`-0.0321190994483`
- Rank ICIR：`-0.228119373264`
- Adjusted ICIR：`0.228119373264`
- Long-short spread (bps)：`7.8918351149`
- Monotonicity：`0.818181818182`
- Coverage：`0.729627806223`
- Daily turnover (long)：`0.0588194148195`
- Daily turnover (short)：`0.0555277092251`
