# doc_huatai_ai21_gp_alpha6_high_low_close_sum_5d
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_ai21_gp_alpha6_high_low_close_sum_5d`
- 默认参数：`{"window":5}`
...
- Rank IC Mean：`0.0404887950734`
- Rank ICIR：`0.367189372029`
- Adjusted ICIR：`0.367189372029`
- Long-short spread (bps)：`36.3882067001`
- Monotonicity：`0.975757575758`
- Coverage：`0.922290335002`
- Daily turnover (long)：`0.420501115156`
- Daily turnover (short)：`0.401978575251`
