...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_xinghuo10_capm_beta_12m`
- 默认参数：`{"clip":[-3.0,3.0],"exclude_suspended_sessions":true,"half_life_days":null,"market_return":"lagged_circ_mv_weighted_available_universe","minimum_valid_days":100,"signal_frequency":"monthly","signal_timing":"previous_completed_month_end","weighting":"capm","window_days":252}`
...
- Rank IC Mean：`-0.00364426515705`
- Rank ICIR：`-0.0286866177078`
- Adjusted ICIR：`-0.0286866177078`
- Long-short spread (bps)：`3.58399916937`
- Monotonicity：`0.745454545455`
- Coverage：`0.883376229158`
- Daily turnover (long)：`0.0397116409548`
- Daily turnover (short)：`0.0411400792122`
