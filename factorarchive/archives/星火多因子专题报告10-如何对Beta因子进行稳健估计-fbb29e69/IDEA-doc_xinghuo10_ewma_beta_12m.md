...
```text
beta from WLS half-life=126d: stock_return ~ 1 + market_return
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_xinghuo10_ewma_beta_12m`
- 默认参数：`{"clip":[-3.0,3.0],"exclude_suspended_sessions":true,"half_life_days":126,"market_return":"lagged_circ_mv_weighted_available_universe","minimum_valid_days":100,"signal_frequency":"monthly","signal_timing":"previous_completed_month_end","weighting":"ewma","window_days":252}`
...
- Rank IC Mean：`-0.00342232423845`
- Rank ICIR：`-0.0258481647861`
- Adjusted ICIR：`-0.0258481647861`
- Long-short spread (bps)：`4.75929996759`
- Monotonicity：`0.781818181818`
- Coverage：`0.883376229158`
- Daily turnover (long)：`0.0405408012827`
- Daily turnover (short)：`0.0439737509189`
