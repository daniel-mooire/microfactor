...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_std_turn_1m`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0519999364635`
- Rank ICIR：`-0.416346712117`
- Adjusted ICIR：`-0.416346712117`
- Long-short spread (bps)：`-20.0653449597`
- Monotonicity：`-0.963636363636`
- Coverage：`0.839972491282`
- Daily turnover (long)：`0.0684369386677`
- Daily turnover (short)：`0.0856406566262`
