...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_turn_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0550281215733`
- Rank ICIR：`-0.406884994785`
- Adjusted ICIR：`-0.406884994785`
- Long-short spread (bps)：`-20.9065746736`
- Monotonicity：`-0.915151515152`
- Coverage：`0.909808936826`
- Daily turnover (long)：`0.108713838459`
- Daily turnover (short)：`0.101229767066`
