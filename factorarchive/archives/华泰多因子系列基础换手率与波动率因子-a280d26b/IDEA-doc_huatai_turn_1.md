...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_turn_1`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0628266733897`
- Rank ICIR：`-0.478573310593`
- Adjusted ICIR：`-0.478573310593`
- Long-short spread (bps)：`-24.5795184891`
- Monotonicity：`-0.866666666667`
- Coverage：`0.998872356786`
- Daily turnover (long)：`0.308613844945`
- Daily turnover (short)：`0.341396525715`
