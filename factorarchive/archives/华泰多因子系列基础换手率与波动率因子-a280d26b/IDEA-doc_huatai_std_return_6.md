...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai_std_return_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0357122963203`
- Rank ICIR：`-0.256910809804`
- Adjusted ICIR：`-0.256910809804`
- Long-short spread (bps)：`-9.66599467702`
- Monotonicity：`-0.975757575758`
- Coverage：`0.621406868687`
- Daily turnover (long)：`0.0346318394696`
- Daily turnover (short)：`0.0292479739108`
