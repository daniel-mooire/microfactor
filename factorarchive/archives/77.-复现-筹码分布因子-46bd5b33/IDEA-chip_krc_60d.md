...
```text
sum(n*TR_W_n*(RC_n-ARC)^4)/(VRC^2*(n-1))
```
...
- Python 实现：`microfactor.factors.document_factors::chip_krc_60d`
- 默认参数：`{}`
...
- Rank IC Mean：`-0.0275505599519`
- Rank ICIR：`-0.363146070223`
- Adjusted ICIR：`-0.363146070223`
- Long-short spread (bps)：`-7.7219342104`
- Monotonicity：`-0.939393939394`
- Coverage：`0.704057064148`
- Daily turnover (long)：`0.152081096965`
- Daily turnover (short)：`0.0998808760183`
