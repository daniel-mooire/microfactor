...
- Python 实现：`microfactor.factors.document_factors::chip_arc_60d`
- 默认参数：`{}`
...
- Rank IC Mean：`-0.0429544406938`
- Rank ICIR：`-0.333201433846`
- Adjusted ICIR：`-0.333201433846`
- Long-short spread (bps)：`-27.5932329324`
- Monotonicity：`-0.951515151515`
- Coverage：`0.73381227863`
- Daily turnover (long)：`0.278208100208`
- Daily turnover (short)：`0.151099908844`
