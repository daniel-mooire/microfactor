...
```text
100*OLS_slope(C[t-4:t]/C[t-4], 0..4)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_etf_slope_5`
- 默认参数：`{}`
...
- Rank IC Mean：`-0.0415445373707`
- Rank ICIR：`-0.330280785318`
- Adjusted ICIR：`-0.330280785318`
- Long-short spread (bps)：`-27.9709132936`
- Monotonicity：`-0.551515151515`
- Coverage：`0.922290335002`
- Daily turnover (long)：`0.386213952392`
- Daily turnover (short)：`0.416861850145`
