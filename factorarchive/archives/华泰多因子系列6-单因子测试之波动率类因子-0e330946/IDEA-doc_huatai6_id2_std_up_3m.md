...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai6_id2_std_up_3m`
...
- Rank IC Mean：`-0.0527088734475`
- Rank ICIR：`-0.448301567811`
- Adjusted ICIR：`0.448301567811`
- Long-short spread (bps)：`17.7745453303`
- Monotonicity：`0.987878787879`
- Coverage：`0.727402679275`
- Daily turnover (long)：`0.0464623982014`
- Daily turnover (short)：`0.0492110232316`
