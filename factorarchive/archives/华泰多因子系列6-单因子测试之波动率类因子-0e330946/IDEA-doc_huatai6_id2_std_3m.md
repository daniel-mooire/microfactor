...
```text
std(epsilon, ddof=0), epsilon from 63d OLS(return ~ 1 + market + size + bp)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai6_id2_std_3m`
...
- Rank IC Mean：`-0.049820163703`
- Rank ICIR：`-0.427533091949`
- Adjusted ICIR：`0.427533091949`
- Long-short spread (bps)：`15.0944458364`
- Monotonicity：`0.963636363636`
- Coverage：`0.727402679275`
- Daily turnover (long)：`0.0455174133008`
- Daily turnover (short)：`0.045037313329`
