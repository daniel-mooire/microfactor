...
```text
sum(epsilon^2 where epsilon<0)/sqrt(63), epsilon from 63d OLS(return ~ 1 + market + size + bp)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_huatai6_id2_std_down_3m`
...
- Rank IC Mean：`-0.044065168543`
- Rank ICIR：`-0.386537320045`
- Adjusted ICIR：`0.386537320045`
- Long-short spread (bps)：`11.9250447809`
- Monotonicity：`0.987878787879`
- Coverage：`0.727402679275`
- Daily turnover (long)：`0.0487681196387`
- Daily turnover (short)：`0.0441072763604`
