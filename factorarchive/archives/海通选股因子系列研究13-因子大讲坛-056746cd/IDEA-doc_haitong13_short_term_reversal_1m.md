# doc_haitong13_short_term_reversal_1m
...
```text
month_end_TRI[t-1] / month_end_TRI[t-2] - 1
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_haitong13_short_term_reversal_1m`
...
- Rank IC Mean：`-0.0187569044879`
- Rank ICIR：`-0.172641357507`
- Adjusted ICIR：`-0.172641357507`
- Long-short spread (bps)：`-9.51199955058`
- Monotonicity：`-0.624242424242`
- Coverage：`0.882921637427`
- Daily turnover (long)：`0.0723429431411`
- Daily turnover (short)：`0.0602031334346`
