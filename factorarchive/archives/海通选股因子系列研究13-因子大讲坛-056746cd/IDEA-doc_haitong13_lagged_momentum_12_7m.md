# doc_haitong13_lagged_momentum_12_7m
...
```text
month_end_TRI[t-7] / month_end_TRI[t-13] - 1
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_haitong13_lagged_momentum_12_7m`
...
- Rank IC Mean：`-0.000114301295787`
- Rank ICIR：`-0.00154907410872`
- Adjusted ICIR：`-0.00154907410872`
- Long-short spread (bps)：`0.483935637787`
- Monotonicity：`0.29696969697`
- Coverage：`0.726970072681`
- Daily turnover (long)：`0.0498665161891`
- Daily turnover (short)：`0.0559610184086`
