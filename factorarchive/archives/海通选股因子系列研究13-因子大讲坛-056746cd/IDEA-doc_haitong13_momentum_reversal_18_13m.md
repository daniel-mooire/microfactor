# doc_haitong13_momentum_reversal_18_13m
...
```text
month_end_TRI[t-13] / month_end_TRI[t-19] - 1
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_haitong13_momentum_reversal_18_13m`
...
- 因子版本：`754cbcc74aaeeffd1c2a`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2017-08-01` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`-0.00306838072551`
- Rank ICIR：`-0.0447145333064`
- Adjusted ICIR：`-0.0447145333064`
- Long-short spread (bps)：`-2.52914795728`
- Monotonicity：`-0.854545454545`
- Coverage：`0.681677492106`
- Daily turnover (long)：`0.0504392409263`
- Daily turnover (short)：`0.0590686977231`
