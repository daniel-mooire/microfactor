...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_029`
- 默认参数：`{"delay_sessions":1,"factor_number":29}`
...
- Rank IC Mean：`0.0383938674769`
- Rank ICIR：`0.398901853368`
- Adjusted ICIR：`0.398901853368`
- Long-short spread (bps)：`15.0068499329`
- Monotonicity：`0.939393939394`
- Coverage：`0.875163706564`
- Daily turnover (long)：`0.621562337695`
- Daily turnover (short)：`0.734437563609`
