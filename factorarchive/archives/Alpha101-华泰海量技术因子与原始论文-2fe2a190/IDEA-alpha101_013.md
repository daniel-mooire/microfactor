...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_013`
- 默认参数：`{"delay_sessions":1,"factor_number":13}`
...
- Rank IC Mean：`0.0363128088915`
- Rank ICIR：`0.522614797971`
- Adjusted ICIR：`0.522614797971`
- Long-short spread (bps)：`16.6302751331`
- Monotonicity：`0.951515151515`
- Coverage：`0.922290335002`
- Daily turnover (long)：`0.481777334695`
- Daily turnover (short)：`0.394794301775`
