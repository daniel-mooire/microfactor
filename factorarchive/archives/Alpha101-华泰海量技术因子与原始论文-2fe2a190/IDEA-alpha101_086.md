...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_086`
- 默认参数：`{"delay_sessions":1,"factor_number":86}`
...
- 因子版本：`f948d95e2413da122360`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-03-29` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`0.0181527274211`
- Rank ICIR：`0.255988938288`
- Adjusted ICIR：`0.255988938288`
- Long-short spread (bps)：`3.33510105135`
- Monotonicity：`0.745454545455`
- Coverage：`0.742441257367`
- Daily turnover (long)：`0.422615331393`
- Daily turnover (short)：`0.412921003082`
