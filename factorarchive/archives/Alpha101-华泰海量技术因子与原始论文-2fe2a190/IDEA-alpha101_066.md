...
合并VWAP短期变化和低价相对VWAP位置的平滑历史排名，再取反。
...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_066`
- 默认参数：`{"delay_sessions":1,"factor_number":66}`
...
- Rank IC Mean：`0.0316621271963`
- Rank ICIR：`0.336860639725`
- Adjusted ICIR：`0.336860639725`
- Long-short spread (bps)：`15.455597438`
- Monotonicity：`0.927272727273`
- Coverage：`0.631771848415`
- Daily turnover (long)：`0.442033485847`
- Daily turnover (short)：`0.454255506686`
