...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_020`
- 默认参数：`{"delay_sessions":1,"factor_number":20}`
...
- Rank IC Mean：`-0.012631823163`
- Rank ICIR：`-0.164738193452`
- Adjusted ICIR：`-0.164738193452`
- Long-short spread (bps)：`-0.00573087599732`
- Monotonicity：`-0.442424242424`
- Coverage：`0.975157692308`
- Daily turnover (long)：`0.763151824974`
- Daily turnover (short)：`0.871570950544`
