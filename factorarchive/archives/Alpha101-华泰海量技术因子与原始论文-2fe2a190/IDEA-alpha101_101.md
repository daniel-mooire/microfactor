...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_101`
- 默认参数：`{"delay_sessions":1,"factor_number":101}`
...
- Rank IC Mean：`-0.029347887546`
- Rank ICIR：`-0.291286570961`
- Adjusted ICIR：`-0.291286570961`
- Long-short spread (bps)：`-16.5397770187`
- Monotonicity：`-0.430303030303`
- Coverage：`0.998898500577`
- Daily turnover (long)：`0.884585209162`
- Daily turnover (short)：`0.890392085449`
