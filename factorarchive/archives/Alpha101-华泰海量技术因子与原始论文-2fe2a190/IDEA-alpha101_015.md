...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_015`
- 默认参数：`{"delay_sessions":1,"factor_number":15}`
...
- Rank IC Mean：`0.0278533025704`
- Rank ICIR：`0.469977169964`
- Adjusted ICIR：`0.469977169964`
- Long-short spread (bps)：`7.50686260149`
- Monotonicity：`0.987878787879`
- Coverage：`0.918325375433`
- Daily turnover (long)：`0.4781176842`
- Daily turnover (short)：`0.489558736845`
