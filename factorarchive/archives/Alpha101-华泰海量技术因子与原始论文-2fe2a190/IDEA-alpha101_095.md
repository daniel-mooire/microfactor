...
输入字段：`open, high, low, volume`

## 原理说明

比较开盘价离近期低点的排名与中间价和成交均值关系的历史位置。
...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_095`
- 默认参数：`{"delay_sessions":1,"factor_number":95}`
...
- Rank IC Mean：`0.0105671346946`
- Rank ICIR：`0.16917015575`
- Adjusted ICIR：`0.16917015575`
- Long-short spread (bps)：`0.651858903402`
- Monotonicity：`0.684848484848`
- Coverage：`0.698317875545`
- Daily turnover (long)：`0.173807041729`
- Daily turnover (short)：`0.193301661307`
