...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_051`
- 默认参数：`{"delay_sessions":1,"factor_number":51}`
...
- Rank IC Mean：`0.0229095393951`
- Rank ICIR：`0.233080849717`
- Adjusted ICIR：`0.233080849717`
- Long-short spread (bps)：`7.17429059667`
- Monotonicity：`-0.0666666666667`
- Coverage：`0.912979077877`
- Daily turnover (long)：`0.461543460229`
- Daily turnover (short)：`0.774522299832`
