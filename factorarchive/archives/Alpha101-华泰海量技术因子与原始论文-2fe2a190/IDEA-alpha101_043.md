...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_043`
- 默认参数：`{"delay_sessions":1,"factor_number":43}`
...
- Rank IC Mean：`0.00444557824634`
- Rank ICIR：`0.0569282080822`
- Adjusted ICIR：`0.0569282080822`
- Long-short spread (bps)：`6.140646384`
- Monotonicity：`0.806060606061`
- Coverage：`0.785684354272`
- Daily turnover (long)：`0.636826414875`
- Daily turnover (short)：`0.600510392959`
