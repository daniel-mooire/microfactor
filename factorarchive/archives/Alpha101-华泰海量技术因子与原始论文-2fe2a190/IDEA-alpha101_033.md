...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_033`
- 默认参数：`{"delay_sessions":1,"factor_number":33}`
...
- Rank IC Mean：`0.0364018829634`
- Rank ICIR：`0.334499124421`
- Adjusted ICIR：`0.334499124421`
- Long-short spread (bps)：`21.9156301259`
- Monotonicity：`0.454545454545`
- Coverage：`0.998898500577`
- Daily turnover (long)：`0.848725089518`
- Daily turnover (short)：`0.821732392013`
