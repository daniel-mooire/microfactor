...
输入字段：`open, close, volume, amount, close_to_close_total_return_1d`

## 原理说明

将日内涨跌、量价相关、滞后收益和长期均价偏离等五种信号加权相加。
...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_036`
- 默认参数：`{"delay_sessions":1,"factor_number":36}`
...
- Rank IC Mean：`0.00755672015777`
- Rank ICIR：`0.110878424773`
- Adjusted ICIR：`0.110878424773`
- Long-short spread (bps)：`-1.12303011194`
- Monotonicity：`-0.139393939394`
- Coverage：`0.532494587843`
- Daily turnover (long)：`0.581918724336`
- Daily turnover (short)：`0.610130323447`
