...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_009`
- 默认参数：`{"delay_sessions":1,"factor_number":9}`
...
- Rank IC Mean：`0.023439950967`
- Rank ICIR：`0.229283676125`
- Adjusted ICIR：`0.229283676125`
- Long-short spread (bps)：`11.3949706109`
- Monotonicity：`0.272727272727`
- Coverage：`0.909828197227`
- Daily turnover (long)：`0.751297019757`
- Daily turnover (short)：`0.782233526058`
