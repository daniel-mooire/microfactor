...
输入字段：`open, high, low, volume, amount`

## 原理说明

用VWAP和成交均值的关系，对比开盘价与日内高低价排名关系，输出条件信号。
...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_062`
- 默认参数：`{"delay_sessions":1,"factor_number":62}`
...
- 因子版本：`4921ca285893cf136145`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-03-17` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`0.0138011420592`
- Rank ICIR：`0.231306700376`
- Adjusted ICIR：`0.231306700376`
- Long-short spread (bps)：`-0.194919187684`
- Monotonicity：`0.272727272727`
- Coverage：`0.760661966314`
- Daily turnover (long)：`0.303854349125`
- Daily turnover (short)：`0.307931926619`
