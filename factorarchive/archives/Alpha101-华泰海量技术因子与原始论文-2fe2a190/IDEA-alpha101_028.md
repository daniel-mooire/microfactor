...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_028`
- 默认参数：`{"delay_sessions":1,"factor_number":28}`
...
- Rank IC Mean：`-0.00361800892372`
- Rank ICIR：`-0.051975830582`
- Adjusted ICIR：`-0.051975830582`
- Long-short spread (bps)：`5.54237687595`
- Monotonicity：`0.151515151515`
- Coverage：`0.829849495733`
- Daily turnover (long)：`0.664300557618`
- Daily turnover (short)：`0.602997207069`
