...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_011`
- 默认参数：`{"delay_sessions":1,"factor_number":11}`
...
- 因子版本：`1103d835a383b2cd8531`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-01-07` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`0.0169789923778`
- Rank ICIR：`0.240552364251`
- Adjusted ICIR：`0.240552364251`
- Long-short spread (bps)：`19.6657447388`
- Monotonicity：`0.939393939394`
- Coverage：`0.937200538876`
- Daily turnover (long)：`0.664058462076`
- Daily turnover (short)：`0.574648570668`
