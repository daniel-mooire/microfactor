...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_006`
- 默认参数：`{"delay_sessions":1,"factor_number":6}`
...
- Rank IC Mean：`0.0237955029869`
- Rank ICIR：`0.320692296257`
- Adjusted ICIR：`0.320692296257`
- Long-short spread (bps)：`13.4819981796`
- Monotonicity：`0.854545454545`
- Coverage：`0.88403742284`
- Daily turnover (long)：`0.351934628771`
- Daily turnover (short)：`0.327690392069`
