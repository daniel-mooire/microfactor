...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_099`
- 默认参数：`{"delay_sessions":1,"factor_number":99}`
...
- 因子版本：`530ceaacd1662773d997`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-05-10` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`0.0105550047324`
- Rank ICIR：`0.170784271508`
- Adjusted ICIR：`0.170784271508`
- Long-short spread (bps)：`0.213368853351`
- Monotonicity：`0.418181818182`
- Coverage：`0.687428287644`
- Daily turnover (long)：`0.195715885908`
- Daily turnover (short)：`0.193496003142`
