...
比较VWAP离近期低点的排名是否低于它与长期成交均值相关性的排名。
...
- Python 实现：`microfactor.factors.alpha101_document::alpha101_061`
- 默认参数：`{"delay_sessions":1,"factor_number":61}`
...
- 因子版本：`a2699104cff57289eeb0`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-10-25` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`0.0184644840028`
- Rank ICIR：`0.224669553691`
- Adjusted ICIR：`0.224669553691`
- Long-short spread (bps)：`4.40724264239`
- Monotonicity：`0.842424242424`
- Coverage：`0.536747714048`
- Daily turnover (long)：`0.173583446641`
- Daily turnover (short)：`0.163298256161`
