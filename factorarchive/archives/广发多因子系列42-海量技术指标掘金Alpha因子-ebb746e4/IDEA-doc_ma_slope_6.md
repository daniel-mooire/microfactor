...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_ma_slope_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0326639084579`
- Rank ICIR：`-0.305185719648`
- Adjusted ICIR：`-0.305185719648`
- Long-short spread (bps)：`-18.5234257212`
- Monotonicity：`-0.430303030303`
- Coverage：`0.879537630259`
- Daily turnover (long)：`0.203422386434`
- Daily turnover (short)：`0.20306838243`
