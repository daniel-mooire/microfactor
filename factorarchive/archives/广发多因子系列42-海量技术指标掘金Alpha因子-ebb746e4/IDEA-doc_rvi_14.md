...
```text
100*SMA(UP,14)/(SMA(UP,14)+SMA(DOWN,14))
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_rvi_14`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0180326552189`
- Rank ICIR：`-0.216884534132`
- Adjusted ICIR：`-0.216884534132`
- Long-short spread (bps)：`-13.6164652734`
- Monotonicity：`-0.927272727273`
- Coverage：`0.823963106796`
- Daily turnover (long)：`0.347127326238`
- Daily turnover (short)：`0.314115103079`
