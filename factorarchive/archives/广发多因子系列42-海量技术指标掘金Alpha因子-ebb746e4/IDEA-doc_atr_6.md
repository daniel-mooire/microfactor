...
```text
MA(max(H-L, abs(H-Ref(C,1)), abs(L-Ref(C,1))), 6)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_atr_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0463449081554`
- Rank ICIR：`-0.517843995087`
- Adjusted ICIR：`-0.517843995087`
- Long-short spread (bps)：`-16.8862154989`
- Monotonicity：`-0.975757575758`
- Coverage：`0.909828197227`
- Daily turnover (long)：`0.130143030153`
- Daily turnover (short)：`0.0919838414777`
