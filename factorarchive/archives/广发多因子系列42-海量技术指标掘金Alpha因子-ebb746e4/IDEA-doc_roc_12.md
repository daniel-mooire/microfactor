...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_roc_12`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0509340055059`
- Rank ICIR：`-0.399751905972`
- Adjusted ICIR：`-0.399751905972`
- Long-short spread (bps)：`-30.3873821987`
- Monotonicity：`-0.69696969697`
- Coverage：`0.934363847045`
- Daily turnover (long)：`0.295436416783`
- Daily turnover (short)：`0.320097427309`
