...
- Python 实现：`microfactor.factors.document_indicators::doc_roc_6`
- 默认参数：`{"N":6}`
- 适配说明：报告正文提到 12/25 日，但结果图同时给出 20/6 日；这里按对应图表固定 N=6，并以百分比形式输出。

## 发布与评估

- Publication status: `published`
- Evaluation status: `passed`
- 因子版本：`10646364e0b130b86e54`
...
- Rank IC Mean：`-0.0483019816596`
- Rank ICIR：`-0.373833410809`
- Adjusted ICIR：`0.373833410809`
- Long-short spread (bps)：`31.0167929966`
- Monotonicity：`0.539393939394`
- Coverage：`0.93111522158`
- Daily turnover (long)：`0.41175163012`
- Daily turnover (short)：`0.373627258015`
