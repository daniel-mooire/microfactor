...
```text
(RSI14-LLV(RSI14,14))/(HHV(RSI14,14)-LLV(RSI14,14))
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_stochrsi_14`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0239686756732`
- Rank ICIR：`-0.24478960416`
- Adjusted ICIR：`-0.24478960416`
- Long-short spread (bps)：`-13.7479779103`
- Monotonicity：`-0.393939393939`
- Coverage：`0.817056721057`
- Daily turnover (long)：`0.498676648503`
- Daily turnover (short)：`0.501838565327`
