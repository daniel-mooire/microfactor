...
```text
100*(20-days_since_lowest_low)/20
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_aroon_down_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`0.0183340251475`
- Rank ICIR：`0.204768826422`
- Adjusted ICIR：`-0.204768826422`
- Long-short spread (bps)：`-5.66463255995`
- Monotonicity：`-0.539393939394`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.315760832011`
- Daily turnover (short)：`0.276968449308`
