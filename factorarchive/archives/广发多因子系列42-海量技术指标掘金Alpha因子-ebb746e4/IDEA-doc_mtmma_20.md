...
- Python 实现：`microfactor.factors.document_indicators::doc_mtmma_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0285775337992`
- Rank ICIR：`-0.271486356466`
- Adjusted ICIR：`-0.271486356466`
- Long-short spread (bps)：`-14.8869737526`
- Monotonicity：`-0.757575757576`
- Coverage：`0.783054644809`
- Daily turnover (long)：`0.071130675988`
- Daily turnover (short)：`0.0688484725183`
