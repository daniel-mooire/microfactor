...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_obv_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0314794262321`
- Rank ICIR：`-0.319027416453`
- Adjusted ICIR：`-0.319027416453`
- Long-short spread (bps)：`-14.7248863866`
- Monotonicity：`-0.393939393939`
- Coverage：`0.901355684008`
- Daily turnover (long)：`0.345656765655`
- Daily turnover (short)：`0.377956465012`
