...
- Python 实现：`microfactor.factors.document_indicators::doc_ddi_dif_13`
...
- Rank IC Mean：`0.0356870302134`
- Rank ICIR：`0.368355162648`
- Adjusted ICIR：`0.368355162648`
- Long-short spread (bps)：`18.6057980078`
- Monotonicity：`0.854545454545`
- Coverage：`0.995125531093`
- Daily turnover (long)：`0.313903137992`
- Daily turnover (short)：`0.337718242415`
