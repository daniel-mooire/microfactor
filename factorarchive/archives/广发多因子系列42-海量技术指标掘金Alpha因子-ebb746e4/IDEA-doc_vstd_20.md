...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_vstd_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0458248571738`
- Rank ICIR：`-0.395269997153`
- Adjusted ICIR：`-0.395269997153`
- Long-short spread (bps)：`-12.2136103386`
- Monotonicity：`-0.939393939394`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.0706332488293`
- Daily turnover (short)：`0.0683658664748`
