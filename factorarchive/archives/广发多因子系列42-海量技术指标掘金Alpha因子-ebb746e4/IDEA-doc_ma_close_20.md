...
- Python 实现：`microfactor.factors.document_indicators::doc_ma_close_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`0.0597125510985`
- Rank ICIR：`0.427071767077`
- Adjusted ICIR：`-0.427071767077`
- Long-short spread (bps)：`-35.9856404287`
- Monotonicity：`-1`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.302655534455`
- Daily turnover (short)：`0.238129567778`
