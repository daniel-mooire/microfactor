...
- Python 实现：`microfactor.factors.document_indicators::doc_arc_20`
- 默认参数：`{}`
- 适配说明：无。
...
- 因子版本：`178891f0462eae556278`
- 数据快照：`snapshot_e3e73aa97706fd71f27ad486`
- 评估批次：`20260917_231028_ee6693d0`
- 有效区间：`2016-03-07` 至 `2026-09-15`

### 核心指标

- Rank IC Mean：`-0.0299876678971`
- Rank ICIR：`-0.245582643355`
- Adjusted ICIR：`-0.245582643355`
- Long-short spread (bps)：`-15.3937848884`
- Monotonicity：`-0.939393939394`
- Coverage：`0.781196798126`
- Daily turnover (long)：`0.0718507791127`
- Daily turnover (short)：`0.0762409266811`
