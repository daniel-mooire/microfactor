...
- Python 实现：`microfactor.factors.document_indicators::doc_dmi_pdi_14`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0510831844723`
- Rank ICIR：`-0.492333375075`
- Adjusted ICIR：`-0.492333375075`
- Long-short spread (bps)：`-24.0393904627`
- Monotonicity：`-0.927272727273`
- Coverage：`0.866644899536`
- Daily turnover (long)：`0.244738303181`
- Daily turnover (short)：`0.265336853363`
