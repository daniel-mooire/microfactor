...
- Python 实现：`microfactor.factors.document_indicators::doc_kdj_j_9_3_3`
- 默认参数：`{}`
...
- Rank IC Mean：`-0.0296443727217`
- Rank ICIR：`-0.277947390134`
- Adjusted ICIR：`-0.277947390134`
- Long-short spread (bps)：`-20.9895342215`
- Monotonicity：`-0.515151515152`
- Coverage：`0.980918121847`
- Daily turnover (long)：`0.417784451036`
- Daily turnover (short)：`0.331209875657`
