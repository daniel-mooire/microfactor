...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_bbi_24`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.011942759075`
- Rank ICIR：`-0.180944419936`
- Adjusted ICIR：`-0.180944419936`
- Long-short spread (bps)：`-6.86496878404`
- Monotonicity：`-0.939393939394`
- Coverage：`0.829921644686`
- Daily turnover (long)：`0.0209332855666`
- Daily turnover (short)：`0.0158806843894`
