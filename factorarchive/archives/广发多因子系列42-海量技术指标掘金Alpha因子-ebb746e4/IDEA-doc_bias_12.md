...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_bias_12`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0543271794435`
- Rank ICIR：`-0.396457077688`
- Adjusted ICIR：`-0.396457077688`
- Long-short spread (bps)：`-33.5448572803`
- Monotonicity：`-0.830303030303`
- Coverage：`0.875163706564`
- Daily turnover (long)：`0.365205382081`
- Daily turnover (short)：`0.303757586069`
