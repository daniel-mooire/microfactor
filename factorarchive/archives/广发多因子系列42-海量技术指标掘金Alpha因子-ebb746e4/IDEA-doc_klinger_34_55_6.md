...
```text
EMA6(EMA34(signed_volume)-EMA55(signed_volume))
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_klinger_34_55_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0257093980364`
- Rank ICIR：`-0.284133514169`
- Adjusted ICIR：`-0.284133514169`
- Long-short spread (bps)：`-9.12521136025`
- Monotonicity：`-0.321212121212`
- Coverage：`0.971367033832`
- Daily turnover (long)：`0.145205339356`
- Daily turnover (short)：`0.127150935327`
