...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_cci_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0469323913638`
- Rank ICIR：`-0.364336123646`
- Adjusted ICIR：`-0.364336123646`
- Long-short spread (bps)：`-24.9072640767`
- Monotonicity：`-0.539393939394`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.361793956448`
- Daily turnover (short)：`0.313126243954`
