...
```text
100*(20-days_since_highest_high)/20
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_aroon_up_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0374472078536`
- Rank ICIR：`-0.401851485253`
- Adjusted ICIR：`-0.401851485253`
- Long-short spread (bps)：`-21.9273498405`
- Monotonicity：`-0.842424242424`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.408727283769`
- Daily turnover (short)：`0.372272021885`
