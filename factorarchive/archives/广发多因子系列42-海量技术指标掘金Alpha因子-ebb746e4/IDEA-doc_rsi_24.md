...
```text
100*SMA(max(delta(C),0),24)/SMA(abs(delta(C)),24)
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_rsi_24`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.048973255733`
- Rank ICIR：`-0.399888967178`
- Adjusted ICIR：`-0.399888967178`
- Long-short spread (bps)：`-28.6199887137`
- Monotonicity：`-0.878787878788`
- Coverage：`0.826644935972`
- Daily turnover (long)：`0.259511497593`
- Daily turnover (short)：`0.251798663015`
