...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_psy_12`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0204043942192`
- Rank ICIR：`-0.236640580651`
- Adjusted ICIR：`-0.236640580651`
- Long-short spread (bps)：`-11.5139077232`
- Monotonicity：`-0.987878787879`
- Coverage：`0.870866743917`
- Daily turnover (long)：`0.307077678028`
- Daily turnover (short)：`0.302308717328`
