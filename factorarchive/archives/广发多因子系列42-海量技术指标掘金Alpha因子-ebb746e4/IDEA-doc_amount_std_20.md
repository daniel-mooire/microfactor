...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_amount_std_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.060642069188`
- Rank ICIR：`-0.498617197521`
- Adjusted ICIR：`-0.498617197521`
- Long-short spread (bps)：`-22.4533105216`
- Monotonicity：`-1`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.0769826928001`
- Daily turnover (short)：`0.0950036144539`
