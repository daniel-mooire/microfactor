...
- Python 实现：`microfactor.factors.document_indicators::doc_price_slope_12`
- 默认参数：`{"N":12}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0377772785755`
- Rank ICIR：`-0.342289325794`
- Adjusted ICIR：`0.342289325794`
- Long-short spread (bps)：`20.7914622777`
- Monotonicity：`0.393939393939`
- Coverage：`0.875163706564`
- Daily turnover (long)：`0.183603882408`
- Daily turnover (short)：`0.178582015389`
