...
- Python 实现：`microfactor.factors.document_indicators::doc_dmi_adxr_14_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0052225081943`
- Rank ICIR：`-0.0660596428446`
- Adjusted ICIR：`-0.0660596428446`
- Long-short spread (bps)：`-2.38844386791`
- Monotonicity：`-0.381818181818`
- Coverage：`0.826644935972`
- Daily turnover (long)：`0.12747256944`
- Daily turnover (short)：`0.160963533231`
