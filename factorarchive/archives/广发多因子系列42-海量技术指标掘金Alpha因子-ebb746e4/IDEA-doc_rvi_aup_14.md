...
```text
AUP=SMA(IF(C>REF(C,1),STD(C,14),0),14,1)
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_rvi_aup_14`
- 默认参数：`{"N":14}`
...
- Rank IC Mean：`-0.0287411631334`
- Rank ICIR：`-0.307488889114`
- Adjusted ICIR：`-0.307488889114`
- Long-short spread (bps)：`-10.8905343936`
- Monotonicity：`-1`
- Coverage：`0.976442330097`
- Daily turnover (long)：`0.120034259846`
- Daily turnover (short)：`0.0891420274262`
