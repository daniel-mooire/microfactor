...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_vroc_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.047378687262`
- Rank ICIR：`-0.528742948625`
- Adjusted ICIR：`-0.528742948625`
- Long-short spread (bps)：`-22.6315964676`
- Monotonicity：`-0.539393939394`
- Coverage：`0.938864393646`
- Daily turnover (long)：`0.43082661984`
- Daily turnover (short)：`0.499805536776`
