...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_asi_20`
- 默认参数：`{}`
- 适配说明：按原文分支定义 R；零分母返回缺失。

## 发布与评估

- Publication status: `published`
- Evaluation status: `rejected`
- 因子版本：`0cd5daed3c8285a60534`
...
- Rank IC Mean：`-0.0488622977275`
- Rank ICIR：`-0.450111711982`
- Adjusted ICIR：`-0.450111711982`
- Long-short spread (bps)：`-27.6885699059`
- Monotonicity：`-0.721212121212`
- Coverage：`0.839984889578`
- Daily turnover (long)：`0.172712493449`
- Daily turnover (short)：`0.164113591626`
