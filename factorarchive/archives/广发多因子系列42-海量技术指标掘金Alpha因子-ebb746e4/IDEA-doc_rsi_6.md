...
```text
100*SMA(max(delta(C),0),6)/SMA(abs(delta(C)),6)
```
...
- Python 实现：`microfactor.factors.document_indicators::doc_rsi_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0402051749022`
- Rank ICIR：`-0.333767115038`
- Adjusted ICIR：`-0.333767115038`
- Long-short spread (bps)：`-24.6092820712`
- Monotonicity：`-0.636363636364`
- Coverage：`0.901354142582`
- Daily turnover (long)：`0.438582480154`
- Daily turnover (short)：`0.438661106067`
