...
```text
sum(C - IF(C>LC,min(L,LC),max(H,LC)), 6)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_acd_6`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.04289894974`
- Rank ICIR：`-0.401237471465`
- Adjusted ICIR：`-0.401237471465`
- Long-short spread (bps)：`-27.7461823063`
- Monotonicity：`-0.587878787879`
- Coverage：`0.901355684008`
- Daily turnover (long)：`0.361475536768`
- Daily turnover (short)：`0.388448013731`
