...
- Python 实现：`microfactor.factors.document_indicators::doc_mtm_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0478419318696`
- Rank ICIR：`-0.42591972493`
- Adjusted ICIR：`-0.42591972493`
- Long-short spread (bps)：`-26.7014977154`
- Monotonicity：`-0.709090909091`
- Coverage：`0.938872917474`
- Daily turnover (long)：`0.244950859795`
- Daily turnover (short)：`0.253527421197`
