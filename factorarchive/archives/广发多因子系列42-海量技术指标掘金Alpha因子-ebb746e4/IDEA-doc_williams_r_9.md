...
- Python 实现：`microfactor.factors.document_indicators::doc_williams_r_9`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0352629439873`
- Rank ICIR：`-0.290654457854`
- Adjusted ICIR：`0.290654457854`
- Long-short spread (bps)：`27.6441543241`
- Monotonicity：`0.406060606061`
- Coverage：`0.888931739298`
- Daily turnover (long)：`0.52058896279`
- Daily turnover (short)：`0.604272728518`
