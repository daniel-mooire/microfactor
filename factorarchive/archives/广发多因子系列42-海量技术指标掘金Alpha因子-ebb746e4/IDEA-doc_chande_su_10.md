...
- Python 实现：`microfactor.factors.document_indicators::doc_chande_su_10`
- 默认参数：`{"N":10}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0538712127029`
- Rank ICIR：`-0.558209888298`
- Adjusted ICIR：`-0.558209888298`
- Long-short spread (bps)：`-23.8203734635`
- Monotonicity：`-0.963636363636`
- Coverage：`0.879537630259`
- Daily turnover (long)：`0.160049778301`
- Daily turnover (short)：`0.186851796641`
