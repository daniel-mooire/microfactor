...
```text
MA(max(H-L, abs(H-Ref(C,1)), abs(L-Ref(C,1))), 20)
```
...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_atr_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0349059912552`
- Rank ICIR：`-0.40020717611`
- Adjusted ICIR：`-0.40020717611`
- Long-short spread (bps)：`-12.4442546456`
- Monotonicity：`-1`
- Coverage：`0.843429899303`
- Daily turnover (long)：`0.0535640752283`
- Daily turnover (short)：`0.0378558691456`
