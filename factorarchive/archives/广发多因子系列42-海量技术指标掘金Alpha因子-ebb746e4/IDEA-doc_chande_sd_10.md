...
- Python 实现：`microfactor.factors.document_indicators::doc_chande_sd_10`
- 默认参数：`{"N":10}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0200603038042`
- Rank ICIR：`-0.207474935111`
- Adjusted ICIR：`0.207474935111`
- Long-short spread (bps)：`3.99294199084`
- Monotonicity：`0.660606060606`
- Coverage：`0.879537630259`
- Daily turnover (long)：`0.179006788733`
- Daily turnover (short)：`0.153663049439`
