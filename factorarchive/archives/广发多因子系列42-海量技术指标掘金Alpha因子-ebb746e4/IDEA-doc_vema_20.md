...
- Python 实现：`microfactor.factors.document_extended:_compute/doc_vema_20`
- 默认参数：`{}`
- 适配说明：无。
...
- Rank IC Mean：`-0.0381723441177`
- Rank ICIR：`-0.315927078622`
- Adjusted ICIR：`-0.315927078622`
- Long-short spread (bps)：`-9.90587290061`
- Monotonicity：`-0.90303030303`
- Coverage：`0.990442292796`
- Daily turnover (long)：`0.0851923092905`
- Daily turnover (short)：`0.0490036790929`
